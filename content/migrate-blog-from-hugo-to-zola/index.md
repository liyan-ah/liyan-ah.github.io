...
1. 主题设置
拷贝一份目标主题的博客，这样就能够省去很多参数的配置的工作。本人这里拷贝的是[st1020/blog](https://github.com/st1020/blog) `Kita`作者本人的博客参数设置。拷贝后保留`content/`目录下的`_index.md`和`pages/`，目录下的其他博文内容删除。调整`config.toml`中的博文说明内容、博客首页栏目内容，调整`content/pages/about.md`中的个人介绍。这样一来，主题设置初步完成。
